...
**4년동안 제1금융권 프로젝트를 포함한 다양한 개발 경험을 쌓았습니다.<br>누구나 사용하기 편하고 원하는 서비스의 개발자이자,<br>Front-End와 Back-End 개발을 구분하지 않는<br>Full-Stack 개발자가 되고싶습니다.**

***1.작은 고민이라도 게을리하지 않으며<br>2.항상 자신의 것에 만족하지 않으며<br>3.새로운 변화를 두려워 하지않으며<br>4.나와 다른 의견일지라도 겸허하게 받아들일 수 있는<br><br>개발자가 되도록 노력하겠습니다 !!***
...
* 다양한 앱 어플리케이션 프로젝트의 화면 개발을 통해 HTML, JavaScript, jQuery 에 대한 많은 개발 경험이 있습니다.
* ECMA 6 이상 문법을 공부하고 실제 개발에서도 많이 사용하고자 노력하고 있습니다.
#### *Vue.js*
* 특정 몇 프로젝트를 통해 Vue.js를 접하게 되었고, 기본적인 Data binding, Vue.js methods, Components, Template 등 개발 가능합니다.

### Back-End
#### *Java, Spring Framework, JPA, JOOQ, MyBatis*
* Spring Framework기반의 RESTful API 개발에 대해 이해하고, 개발 가능합니다.
* JPA를 이용한 API 개발이 가능하고, JPA의 단점을 보완할 JOOQ 개발 경험이 있습니다.
#### *AWS, Docker, Jenkins, Travis CI, NGINX, Redis*
* AWS를 이용한 Cloud Server 구축 및 Web Application 배포 경험이 있습니다.
* Docker와 Jenkins를 이용한 배포를 통해 안전하고 유지보수가 용이한 DevOps 환경 구축 가능합니다.
* Travis CI와 NGINX를 활용하여 Github 무중단 배포 환경을 구축하였고, Redis를 적용한 Caching Server 환경 구축 가능합니다.
